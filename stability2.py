...
def writeWNcfg(m):
    ...
    fout = open("/home/tanner/src/wnpy2/stability/stability.cfg", 'w')
...
#    fout.write('vegetation                  =   grass\n')
    ...
    fout.write('wx_station_kml_filename     =   /home/tanner/src/wnpy2/stability/backup.kml\n')
    fout.write('write_ascii_output          =   true\n')
    fout.write('output_path                 =   /home/tanner/src/wnpy2/stability/')
...
def runWN():
    print "Running WindNinja... stability.py"
#    subprocess32.call(['export WINDNINJA_DATA=~/src/wind/windninja/data'])
    subprocess32.call(['/home/tanner/src/wind/build/src/cli/./WindNinja_cli','/home/tanner/src/wnpy2/stability/stability.cfg'])
...
def renameFiles():
    ...
    kmz=glob.glob('/home/tanner/src/wnpy2/stability/*.kmz')
    os.rename(kmz[0],'/home/tanner/src/wnpy2/stability/pStability.zip')
    vel=glob.glob('/home/tanner/src/wnpy2/stability/*_vel.asc')
    ang=glob.glob('/home/tanner/src/wnpy2/stability/*_ang.asc')
    os.rename(vel[0],'/home/tanner/src/wnpy2/stability/data/velStability.asc')
    os.rename(ang[0],'/home/tanner/src/wnpy2/stability/data/angStability.asc')
    
def extractZip():
    print "extracting KMLs from ZIP..."
    with zipfile.ZipFile('/home/tanner/src/wnpy2/stability/pStability.zip',"r") as z:
        z.extractall('/home/tanner/src/wnpy2/stability/data')

def renameZipExtracts():
    print "renaming zip files..."
    kmlGrid=glob.glob('/home/tanner/src/wnpy2/stability/data/poph_*.kml')
    key=glob.glob('/home/tanner/src/wnpy2/stability/data/poph_*_stability.bmp')
    os.rename(kmlGrid[0],'/home/tanner/src/wnpy2/stability/data/pStability.kml')
    os.rename(key[0],'/home/tanner/src/wnpy2/stability/data/pStability.bmp')
...
def writeVelocityFile():
    ...
    vel=list(csv.reader(open('/home/tanner/src/wnpy2/stability/data/velStability.asc','rb'),delimiter='\t'))
    ...
    with open('/home/tanner/src/wnpy2/stability/data/StabilityVelocity.csv','a') as csvfile:
...
def writeAngleFile():
    ...
    info=time.time()
    m=list(csv.reader(open('/home/tanner/src/wnpy2/d.csv','rb')))
    vel=list(csv.reader(open('/home/tanner/src/wnpy2/stability/data/angStability.asc','rb'),delimiter='\t'))
    ...
    with open('/home/tanner/src/wnpy2/stability/data/StabilityAngle.csv','a') as csvfile:
        blue=csv.writer(csvfile,delimiter=',')
        dat=[info,NCRM8,nnNCRM8,TS673,nnTS673,PHYM8,nnPHYM8]
        blue.writerow(dat)
def moveLocalFiles():
    print "moving stability Sim Files to ninjaoutput..."
    shutil.copyfile('/home/tanner/src/wnpy2/stability/data/pStability.bmp','/home/tanner/ninjaoutput/thermal/pStability.bmp')
    shutil.copyfile('/home/tanner/src/wnpy2/stability/data/pStability.kml','/home/tanner/ninjaoutput/thermal/pStability.kml')
